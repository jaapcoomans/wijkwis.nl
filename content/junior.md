---
title: WijKwis Junior
layout: :theme/page
---

# <span style="color: #856404;"><i class="fas fa-child me-2"></i> Wat is de WijKwis Junior?</span>

<div class="card border-0 shadow-sm mb-4" style="background-color: #fffde7; border-left: 5px solid #ffc107 !important;">
    <div class="card-body">
        <p class="mb-0" style="color: #856404;">De WijKwis Junior is een speciaal programma voor de jonge speurders in de wijk. Terwijl de volwassenen zich voorbereiden op hun avondvullende programma, toveren we de middag om tot een groot avontuur voor kinderen van <strong>8 tot 12 jaar</strong>. Gezelligheid, puzzelen en samenwerken staan centraal!</p>
    </div>
</div>
